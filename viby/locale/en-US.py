...
TOOLS = {
    ...
    "embed_server_started": "Embedding model server has been started",
    "embed_server_stopped": "Embedding model server has been stopped",
    ...
    "error_starting_server": "Error occurred while starting server",
    "error_stopping_server": "Error occurred while stopping server",
    "embed_server_running": "Embedding model server is running",
    "embed_server_status_unknown": "Embedding model server status is unknown",
    "embed_server_status_check_failed": "Failed to check embedding model server status",
    "error_checking_server": "Error occurred while checking server status",
