...
def test_handle_shell_command_yolo_safe(mock_print, mock_prompt, mock_execute, mock_is_yolo_enabled):
    """测试yolo模式下处理安全命令"""
    # 模拟yolo模式开启
...
@patch('viby.llm.nodes.handlers.shell_handler.prompt')
@patch('viby.llm.nodes.handlers.shell_handler.print')
def test_handle_shell_command_yolo_unsafe(mock_print, mock_prompt, mock_execute, mock_is_yolo_enabled):
    """测试yolo模式下处理不安全命令"""
    # 模拟yolo模式开启
    mock_is_yolo_enabled.return_value = True
...
@patch('viby.llm.nodes.handlers.shell_handler.prompt')
@patch('viby.llm.nodes.handlers.shell_handler.print')
def test_handle_shell_command_no_yolo(mock_print, mock_prompt, mock_execute, mock_is_yolo_enabled):
    """测试非yolo模式下处理命令"""
    # 模拟yolo模式关闭
